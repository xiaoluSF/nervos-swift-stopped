...
class nervosswift_ERC20_Tests: XCTestCase {
    ...
    func testERC20balanceUsingABIv2() {
        ...
        do {
            ...
            let options = NervosOptions.defaultOptions()
    ...
    func testInfuraERC20name() {
        ...
        let contract = nervos.contract(jsonString, at: contractAddress)
    ...
    func testERC20tokenBalance() {
        let nervos = Nervos.InfuraMainnetNervos()
        let contract = nervos.contract(Nervos.Utils.erc20ABI, at: EthereumAddress("0x45245bc59219eeaaf6cd3f382e078a461ff9de7b")!, abiVersion: 2)
