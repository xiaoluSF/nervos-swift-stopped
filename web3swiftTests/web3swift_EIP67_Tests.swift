...
class nervosswift_EIP67_Tests: XCTestCase {
    
    func testEIP67encoding() {
        var eip67Data = Nervos.EIP67Code.init(address: EthereumAddress("0x6394b37Cf80A7358b38068f0CA4760ad49983a1B")!)
    ...
    func testEIP67decoding() {
        ...
        //        eip67Data.data =
        let encoding = eip67Data.toString()
        guard let code = Nervos.EIP67CodeParser.parse(encoding) else {return XCTFail()}
