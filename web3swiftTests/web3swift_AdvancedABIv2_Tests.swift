//
//  nervosswift_AdvancedABIv2_Tests.swift
...
class nervosswift_AdvancedABIv2_Tests: XCTestCase {
    ...
    func testAdvancedABIv2() {
        ...
        let contract = nervos.contract(abiString, at: contractAddress, abiVersion: 2)
