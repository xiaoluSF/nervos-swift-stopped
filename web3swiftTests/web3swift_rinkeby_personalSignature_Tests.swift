//
//  nervosswift_personal_signature_Tests.swift
...
class nervosswift_rinkeby_personalSignature_Tests: XCTestCase {
    ...
    func testPersonalSignature() {
        ...
        let signRes = nervos.personal.signPersonalMessage(message: message.data(using: .utf8)!, from: expectedAddress, password: "")
        ...
        print("Personal hash = " + Nervos.Utils.hashPersonalMessage(message.data(using: .utf8)!)!.toHexString())
        let recoveredSigner = nervos.personal.ecrecover(personalMessage: message.data(using: .utf8)!, signature: signature)
    ...
    func testPersonalSignatureOnContract() {
        ...
        let contract = nervos.contract(jsonString, at: EthereumAddress("0x6f1745a39059268e8e4572e97897b50e4aab62a8"), abiVersion: 2)
        ...
        case .success(let res):
            ...
            XCTAssert(Nervos.Utils.hashPersonalMessage(message.data(using: .utf8)!)! == hash)
