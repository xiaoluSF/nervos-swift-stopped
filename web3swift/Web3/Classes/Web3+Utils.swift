...
public typealias NervosUtils = Nervos.Utils
...
extension Nervos.Utils {
    public static func calcualteContractAddress(from: EthereumAddress, nonce: BigUInt) -> EthereumAddress? {
        ...
        guard let contractAddressData = Nervos.Utils.sha3(data)?[12..<32] else {return nil}
...
extension Nervos.Utils {
    ...
    public static func publicToAddress(_ publicKey: Data) -> EthereumAddress? {
        guard let addressData = Nervos.Utils.publicToAddressData(publicKey) else {return nil}
    ...
    public static func parseToBigUInt(_ amount: String, units: Nervos.Utils.Units = .eth) -> BigUInt? {
    ...
    public static func formatToEthereumUnits(_ bigNumber: BigInt, toUnits: Nervos.Utils.Units = .eth, decimals: Int = 4, decimalSeparator: String = ".") -> String? {
    ...
    public static func formatToEthereumUnits(_ bigNumber: BigUInt, toUnits: Nervos.Utils.Units = .eth, decimals: Int = 4, decimalSeparator: String = ".", fallbackToScientific: Bool = false) -> String? {
    ...
    static public func personalECRecover(_ personalMessage: String, signature: String) -> EthereumAddress? {
        ...
        return Nervos.Utils.personalECRecover(data, signature:sig)
    }
